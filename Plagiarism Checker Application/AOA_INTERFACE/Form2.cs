...
namespace AOA_INTERFACE
{
    public partial class Form2 : Form
    {
...

        {
            ...
            for (int q = 0; q <= temp; q++)
            {
                string s = lcs[q].ToString();
                {
                    ...
                    String path = @"C:\Users\HP\OneDrive\Desktop\INTERFACE.txt";
            ...
            string file_data = System.IO.File.ReadAllText(@"C:\Users\HP\OneDrive\Desktop\INTERFACE.txt");
        ...
        void lcs2(string X, string Y)
        {
            ...
            string fileData = System.IO.File.ReadAllText(@"C:\Users\HP\OneDrive\Desktop\PROJECT_2Folder.txt");
